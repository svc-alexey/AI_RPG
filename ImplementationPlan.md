...
- [ ] Визуальный стиль приложения соответствует референсам по настроению и композиции
- [ ] Интерфейс ощущается более премиальным и атмосферным
- [ ] Анимации улучшают UX и не мешают сценарию игры
