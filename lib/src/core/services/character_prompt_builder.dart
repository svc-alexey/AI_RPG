...
class CharacterPromptBuilder {
  ...
  String buildPrompt({
    ...
    parts.add(_label('class', language) + _classLabel(profile.characterClass, language));
  ...
  String _raceLabel(final String raceId, final CampaignSetting setting, final AppLanguage language) {
    return switch ((raceId, setting, language)) {
  ...
  CharacterProfile randomProfile({
    ...
    final List<CharacterClass> classes = classesBySetting[setting] ?? <CharacterClass>[CharacterClass.warrior];
    ...
    final CharacterGender gender = CharacterGender.values[_random.nextInt(CharacterGender.values.length)];
    final String personalityId = personalityTemplates[_random.nextInt(personalityTemplates.length)];
    ...
    final List<String> defaultSkills = _defaultSkillsForClass(charClass, language);
    final List<String> defaultPerks = _defaultPerksForClass(charClass, setting, language);
  ...
  List<String> _defaultSkillsForClass(final CharacterClass c, final AppLanguage language) {
    return switch ((c, language)) {
      (CharacterClass.warrior, AppLanguage.ru) => <String>['Ближний бой', 'Выносливость'],
      (CharacterClass.warrior, AppLanguage.en) => <String>['Melee combat', 'Endurance'],
      ...
      (CharacterClass.rogue, AppLanguage.en) => <String>['Stealth', 'Lockpicking'],
      (CharacterClass.detective, AppLanguage.ru) => <String>['Дедукция', 'Наблюдательность'],
      (CharacterClass.detective, AppLanguage.en) => <String>['Deduction', 'Observation'],
      (CharacterClass.journalist, AppLanguage.ru) => <String>['Интервью', 'Расследование'],
      (CharacterClass.journalist, AppLanguage.en) => <String>['Interview', 'Investigation'],
      ...
      (CharacterClass.engineer, AppLanguage.ru) => <String>['Ремонт', 'Хакерство'],
      (CharacterClass.engineer, AppLanguage.en) => <String>['Repair', 'Hacking'],
      (CharacterClass.pilot, AppLanguage.ru) => <String>['Пилотирование', 'Навигация'],
      (CharacterClass.pilot, AppLanguage.en) => <String>['Piloting', 'Navigation'],
      (CharacterClass.medic, AppLanguage.ru) => <String>['Медицина', 'Диагностика'],
      (CharacterClass.medic, AppLanguage.en) => <String>['Medicine', 'Diagnostics'],
      _ => <String>[],
    };
  }
  ...
  List<String> _defaultPerksForClass(
    ...
    return switch ((c, setting, language)) {
      (CharacterClass.warrior, CampaignSetting.fantasy, AppLanguage.ru) => <String>['Закалённый щит'],
      (CharacterClass.warrior, CampaignSetting.fantasy, AppLanguage.en) => <String>['Tempered shield'],
      (CharacterClass.mage, CampaignSetting.fantasy, AppLanguage.ru) => <String>['Кристалл фокуса'],
      (CharacterClass.mage, CampaignSetting.fantasy, AppLanguage.en) => <String>['Focus crystal'],
      (CharacterClass.rogue, CampaignSetting.fantasy, AppLanguage.ru) => <String>['Набор отмычек'],
      (CharacterClass.rogue, CampaignSetting.fantasy, AppLanguage.en) => <String>['Lockpick set'],
      (CharacterClass.detective, CampaignSetting.detective, AppLanguage.ru) => <String>['Блокнот'],
      (CharacterClass.detective, CampaignSetting.detective, AppLanguage.en) => <String>['Notebook'],
      (CharacterClass.journalist, CampaignSetting.detective, AppLanguage.ru) => <String>['Диктофон'],
      (CharacterClass.journalist, CampaignSetting.detective, AppLanguage.en) => <String>['Recorder'],
      (CharacterClass.smuggler, CampaignSetting.detective, AppLanguage.ru) => <String>['Фальшивые документы'],
      (CharacterClass.smuggler, CampaignSetting.detective, AppLanguage.en) => <String>['Fake papers'],
      (CharacterClass.engineer, CampaignSetting.sciFi, AppLanguage.ru) => <String>['Мультитул'],
      (CharacterClass.engineer, CampaignSetting.sciFi, AppLanguage.en) => <String>['Multitool'],
      (CharacterClass.pilot, CampaignSetting.sciFi, AppLanguage.ru) => <String>['Навигационный чип'],
      (CharacterClass.pilot, CampaignSetting.sciFi, AppLanguage.en) => <String>['Nav chip'],
      (CharacterClass.medic, CampaignSetting.sciFi, AppLanguage.ru) => <String>['Медпакет'],
      (CharacterClass.medic, CampaignSetting.sciFi, AppLanguage.en) => <String>['Medkit'],
      _ => <String>[],
    };
  }
  ...
  String _buildRandomPromptFragment({
    ...
    final List<String> parts = <String>[];
    parts.add('$name, $race $characterClass');
    parts.add(_label('gender', language) + gender);
    parts.add(_label('personality', language) + personality);
